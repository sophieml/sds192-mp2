...
Our next graph offers a more clear comparison of the different occupations within each career field. For clarification, the occupations in the data are not limited to those included in this graphic. Since this data was so large, we only included the specific occupations with more than 10,000 donors. This also helped avoid clutter.
```{r, message=FALSE, warning=FALSE, echo=FALSE}
